...
/*   Updated: 2026/02/22 13:15:46 by ykonka           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
scaling-factor       =  value - x_old[min] / x_old[max] - x_old[min]        :: old system factor abstraction
translation          =  scaling-factor * x_new[max] - x_new[min]            :: old -> new
transformed-value    =  translation + x_new[min];                           :: positioning in new
